...
- Revisión del proyecto: Evento al final de una fase para evaluar el estado de este y determinar si está listo para pasar a la siguiente fase o para hacer la transición a operaciones.
- Comité de dirección: Los interesados sénior proporcionan dirección y apoyo al equipo del proyecto y toman decisiones.
- Planificación de *Sprint*: Aclarar detalles del *backlog*, los criterios de aceptación y el esfuerzo de trabajo requerido.
- Revisión de Sprint: Es celebrada al final de una iteración para demostrar el trabajo realizado durante la misma.
- Reunión de lecciones aprendidas: Identificar y compartir los conocimientos adquiridos durante un proyecto, fase o iteración con el objetivo de mejorar el desempeño del equipo.
...
##### Caso de negocio
- Propuesta de valor de un proyecto.
  - Problema
  - Solución
  - Beneficios
  - Alcance
  ...
  - Costos
  - Métricas
- Lienzo del modelo de negocio: Resumen visual que describe la propuesta de valor, infraestructura, clientes y finanzas.
  - Segmento de mercado
  - Propuesta de valor
  - Canales
...
- Interrelaciones y posibles conflictos de poder
- Requisitos de comunicaciones
- Información a distribuir, incluido el idioma, formato, contenido y nivel de detalle
- Motivos e impacto de la distribución
- Calendario y frecuencia de la distribución de la información
